...
public sealed class PostgresDataIntegrityTests
{
    ...
    [Fact]
    public async Task RowVersion_OnUserInsert_IsGeneratedByTrigger()
    {
    ...
    public async Task CategoryStats_ReturnsTenantScopedAndSoftDeleteScopedValues()
    {
        ...
        await IntegrationAuthHelper.AuthenticateAsync(_client, usernameA, "pass-a");
    ...
    public async Task DeleteProduct_WithExistingReviews_CurrentlyReturnsInternalServerError()
    {
        ...
        await IntegrationAuthHelper.AuthenticateAsync(_client, username, "pass-cascade");
    ...
    public async Task CategoryStats_FunctionCallable_ReturnsZeroValuesForEmptyCategory()
    {
        ...
        await IntegrationAuthHelper.AuthenticateAsync(_client, username, "pass-smoke");
